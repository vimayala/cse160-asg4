...
class Camera{
    constructor(){
        this.eye = new Vector3([-2.2112262964248657, 0.73259633779525757, -2.1792638301849365]);
        this.at = new Vector3([-1.2585904598236084, 0.6384878158569336, -1.2162953615188599]);
    ...
    addBlock(distance) {
        ...
        this.addBlockDirection.normalize();

        this.addBlockDistance.set(this.addBlockDirection);
        this.addBlockDistance.mul(distance);
